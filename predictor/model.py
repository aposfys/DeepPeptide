...
class CRFBaseModel(nn.Module):
    ...
    def get_crf_constraints(max_len: int = 60, min_len: int = 5):
        ...
        allowed_state_transitions.append((0,1)) # None to Propeptide_0
        allowed_state_transitions.append((max_len,1)) # Propeptide_50 to Propeptide_0, no need to have 1 AA gap
        allowed_state_transitions.append((max_len,0)) # Propeptide_50 (peptide end position) to None
